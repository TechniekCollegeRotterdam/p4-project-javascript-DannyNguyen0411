...
let sanic = document.querySelector("#sanic");
let x;
let y;
let isPaused = false;
let isPlay = true;
...
sanic.addEventListener('click', theme);
 ...
 */
function theme(){
    let sanic_SOUND=new Audio('music/sanic.mp3');
    sanic_SOUND.volume=0.7;
...
function showPauseMenu()
{
  ...
  sanic.style.visibility = "visible";
